      ...
      <el-main>
        <div class="back-module">
          <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>
              <el-link href="https://element.eleme.io" target="_blank">旅游线路</el-link>
            </el-breadcrumb-item>
          </el-breadcrumb>
        </div>
        <div class="fa-top">
            ...
            <div class="chose-brand">
              ...
              <div class="brand-all">
                ...
                <el-checkbox-group class="chose-box" v-model="checkedRoutes" :min="0" :max="8">
                  <el-checkbox v-for="route in routes" :label="route" :key="route">{{ route }}</el-checkbox>
                </el-checkbox-group>
              </div>
            </div>
            <el-divider class="apart-line"></el-divider>
        ...
        <div class="list-wrap" data-list="1" style="display: block;">
          <a class="item clearfix" href="/sales/2414699.html" target="_blank">
            <div class="image">
              <img
            ...
            <div class="detail">
              <div class="info" style="position: relative">
                <p>月售911</p>
                <h3>龙脊牧歌 纯玩无购物 8人VIP商务小团龙脊金坑大寨纯玩一日游（ 可选阳朔出发 送竹筒饭 酒店接送 /单双索道）</h3>
                <div class="s-tag">
                  <span>酒店接送</span>
                  <span>少数民族风情</span>
                  <span>纯玩商务车</span>
              ...
              <div class="extra">
                <div class="action">
                  <el-button type="warning" class="btn">立即订购</el-button>
          ...
          <a class="item clearfix" href="/sales/2803990.html" target="_blank">
            <div class="image">
              <img
          ...
          <a class="item clearfix" href="/sales/2829691.html" target="_blank">
            <div class="image">
              <img
            ...
            <div class="detail">
              <div class="info" style="position: relative">
                <p>月售128</p>
                <h3>独立包车 桂林龙脊漓江阳朔4日全景包车游（纯玩无车购+入住豪华酒店+赠纪念金币+下午茶）</h3>
                <div class="s-tag">
                  <span>行程天数可调</span>
                  <span>一对一定制线路</span>
                  <span>独立用车轻松自由</span>
          ...
          <a class="item clearfix" href="/sales/2497389.html" target="_blank">
            <div class="image">
              <img
          ...
          <a class="item clearfix" href="/sales/2913803.html" target="_blank">
            <div class="image">
              <img
          ...
          <a class="item clearfix" href="/sales/2611270.html" target="_blank">
            <div class="image">
              <img
            ...
            <div class="detail">
              <div class="info" style="position: relative">
                <p>月售358</p>
                <h3>十六年品质经典 ·赠阳朔接送 ·阳朔印象刘三姐 大型山水实景演出 新贵宾/老贵宾/普通票（可选场次+可选坐席+正规票源）</h3>
                <div class="s-tag">
                  <span>可选场次</span>
                  <span>张艺谋导演作品</span>
                </div>
          ...
          <a class="item clearfix" href="/sales/5140274.html" target="_blank">
            <div class="image">
              <img
            ...
            <div class="detail">
              <div class="info" style="position: relative">
                <p>月售373</p>
                <h3>五一黄金时段有票·桂林两江四湖景区/日游一江四湖游船票 夜游两江四湖豪华船 （登船码头取票 方便快捷）</h3>
                <div class="s-tag">
                  <span>码头取票</span>
                  <span>可选时间</span>
                  <span>东方威尼斯</span>
          ...
          <a class="item clearfix" href="/sales/2915435.html" target="_blank">
            <div class="image">
              <img
            ...
            <div class="detail">
              <div class="info" style="position: relative">
                <p>月售511</p>
                <h3>桂林漓江精华一日游||保证纯玩▪ 不车购▪（城徽象鼻山+漓江竹筏+银子岩+兴坪古镇赏20RMB+赠返桂不限天数）</h3>
                <div class="s-tag">
                  <span>8人mini团</span>
                  <span>纯玩无隐性消费</span>
                  <span>赠矿泉水</span>
          ...
          <a class="item clearfix" href="/sales/2119691.html" target="_blank">
            <div class="image">
              <img
...
const timeOptions = ["6月", "7月", "8月", "9月", "10月"];
export default {
  data() {
    return {
      checkedTypes: ["象山公园", "两江四湖"],
      types: typeOptions,
      checkedRoutes: ["桂林+阳朔"],
      routes: routeOptions,
      checkedTimes: ["6月"],
  ...
  methods: {
    handleCheckAllChange1(val) {
      this.checkedRoutes = val ? routeOptions : [];
...
.image {
  background: #e5e5e5 url(/images/sales/logo-white.png) no-repeat center center;
  position: relative;
}
.list-wrap .detail {
  float: right;
